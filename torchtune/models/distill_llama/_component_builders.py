...
def distill_llama(
    ...
    self_attn = CausalSelfAttention(
        ...
        output_proj=FactorizedLinear(
            embed_dim, inner_dim, embed_dim, bias=False, device=device
        ),
        pos_embeddings=rope,
...
def distill_llama_mlp(embed_dim: int, inner_dim: int, hidden_dim: int) -> FeedForward:
    ...
    """
    gate_proj = FactorizedLinear(embed_dim, inner_dim, hidden_dim, bias=False)
    down_proj = FactorizedLinear(embed_dim, inner_dim, hidden_dim, bias=False)
    up_proj = FactorizedLinear(hidden_dim, inner_dim, embed_dim, bias=False)
